...
: ${AMENT_CURRENT_PREFIX:="/home/nick/dev/pi_bot_ws/install/i2c_comm_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/i2c_comm_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/i2c_comm_cpp/environment/path.sh"
