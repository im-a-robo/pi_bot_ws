...
: ${AMENT_CURRENT_PREFIX:="/home/nick/dev/pi_bot_ws/install/hat_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hat_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hat_test/environment/path.sh"
